 ...
 */                                                                                                                  // 83
Accounts.onResetPasswordLink = function (callback) {                                                                 // 84
  if (accountsCallbacks["reset-password"]) {                                                                         // 85
    Meteor._debug("Accounts.onResetPasswordLink was called more than once. " +                                       // 86
      "Only one callback added will be executed.");                                                                  // 87
  }                                                                                                                  // 88
                                                                                                                     // 89
  accountsCallbacks["reset-password"] = callback;                                                                    // 90
};                                                                                                                   // 91
                                                                                                                     // 92
/**                                                                                                                  // 93
 * @summary Register a function to call when an email verification link is                                           // 94
 * clicked in an email sent by                                                                                       // 95
 * [`Accounts.sendVerificationEmail`](#accounts_sendverificationemail).                                              // 96
 * This function should be called in top-level code, not inside                                                      // 97
 * `Meteor.startup()`.                                                                                               // 98
 * @param  {Function} callback The function to call. It is given two arguments:                                      // 99
 *                                                                                                                   // 100
 * 1. `token`: An email verification token that can be passed to                                                     // 101
 * [`Accounts.verifyEmail`](#accounts_verifyemail).                                                                  // 102
 * 2. `done`: A function to call when the email verification UI flow is complete.                                    // 103
 * The normal login process is suspended until this function is called, so                                           // 104
 * that the user can be notified that they are verifying their email before                                          // 105
 * being logged in.                                                                                                  // 106
 */                                                                                                                  // 107
Accounts.onEmailVerificationLink = function (callback) {                                                             // 108
  if (accountsCallbacks["verify-email"]) {                                                                           // 109
    Meteor._debug("Accounts.onEmailVerificationLink was called more than once. " +                                   // 110
      "Only one callback added will be executed.");                                                                  // 111
  }                                                                                                                  // 112
                                                                                                                     // 113
  accountsCallbacks["verify-email"] = callback;                                                                      // 114
};                                                                                                                   // 115
                                                                                                                     // 116
/**                                                                                                                  // 117
 * @summary Register a function to call when an account enrollment link is                                           // 118
 * clicked in an email sent by                                                                                       // 119
 * [`Accounts.sendEnrollmentEmail`](#accounts_sendenrollmentemail).                                                  // 120
 * This function should be called in top-level code, not inside                                                      // 121
 * `Meteor.startup()`.                                                                                               // 122
 * @param  {Function} callback The function to call. It is given two arguments:                                      // 123
 *                                                                                                                   // 124
 * 1. `token`: A password reset token that can be passed to                                                          // 125
 * [`Accounts.resetPassword`](#accounts_resetpassword) to give the newly                                             // 126
 * enrolled account a password.                                                                                      // 127
 * 2. `done`: A function to call when the enrollment UI flow is complete.                                            // 128
 * The normal login process is suspended until this function is called, so that                                      // 129
 * user A can be enrolled even if user B was logged in.                                                              // 130
 */                                                                                                                  // 131
Accounts.onEnrollmentLink = function (callback) {                                                                    // 132
  if (accountsCallbacks["enroll-account"]) {                                                                         // 133
    Meteor._debug("Accounts.onEnrollmentLink was called more than once. " +                                          // 134
      "Only one callback added will be executed.");                                                                  // 135
  }                                                                                                                  // 136
                                                                                                                     // 137
  accountsCallbacks["enroll-account"] = callback;                                                                    // 138
};                                                                                                                   // 139
                                                                                                                     // 140
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
